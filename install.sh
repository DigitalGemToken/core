...
echo 'alias digitalgem="$HOME/core-bridgechain/packages/core/bin/run"' >> ~/.bashrc

rm -rf "$HOME/core-bridgechain"
git clone "https://github.com/DigitalGemToken/core.git" "$HOME/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/DigitalGemToken/core.git'"
...
rm -rf "$HOME/.config/@digitalgem"
rm -rf "$HOME/.config/@digitalgem"
rm -rf "$HOME/.config/digitalgem-core"
